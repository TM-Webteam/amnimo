    ...
    <div class="inner">
      ...
      <div class="ftr-nav">
        <ul class="clm">
          ...
          <li class="indent"><a href="/service/compact_router_wifi/">無線LAN搭載型コンパクトルーター（屋内版）</a></li>
          <li class="indent"><a href="/service/compact_router_outdoor/">【開発中】無線LAN搭載型コンパクトルーター（屋外版）</a></li>
