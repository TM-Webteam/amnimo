  ...
  <section class="">
    <div class="containers flex">
      ...
      <article class="main-conts single">
        ...
        <h1 class="single__h1">記事タイトルが入ります。記事タイトルが入ります。記事タイトルが入（32文字で設定）</h1>
        ...
        <a href="#" class="flex cardLink">
          ...
          <summary class="cardLink__box">
            <div class="cardLink__box--ttl">IoTゲートウェイとは？導入によるメリットと活用事例</div>
            <div class="cardLink__box--txt">インターネット社会の発達と共に、数多くのいわゆる「ネット用語」が世の中に氾濫しています。ただ「…</div>
          </summary>
        </a>
        ...
        <div class="single__img">
          <img src="<?php echo assets_path() ?>img/common/img-single02.jpg" alt="">
        </div>
    ...
    <div class="containers">
      ...
      <div class="flex card">
        <a href="#" class="card__box">
          ...
          <h3 class="card__box--ttl"><div>コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。</div></h3>
        </a>
        <a href="#" class="card__box">
          <figure class="card__box--img"><img src="<?php echo assets_path() ?>img/common/img01.jpg" alt=""></figure>
          <h3 class="card__box--ttl"><div>コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。</div></h3>
        ...
        <a href="#" class="card__box">
          <figure class="card__box--img"><img src="<?php echo assets_path() ?>img/common/img02.jpg" alt=""></figure>
          <h3 class="card__box--ttl"><div>コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。コラムタイトルが入ります。</div></h3>
        </a>
      </div>
    </div>
